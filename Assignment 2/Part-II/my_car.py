...
class MyCar(Car):
    ...
    def move(self, weights, params):
        ...
        * The car's current y velocity (vy)
        ...
        features_x = (np.array([params['x'], params['prev_x'] - params['x'], params['vx'], params['prev_vx'] - params['vx'], params['dist_front_left'], params['dist_front_right']]))
        # features_x = (features_x - np.mean(features_x))/np.std(features_x)
        features_y = (np.array([params['y'], params['prev_y'] - params['y'], params['vy'], params['prev_vy'] - params['vy'], params['dist_left'], params['dist_right']])) 
        ...
        '''
        # print(max_ax, W1.shape, features_x.T.shape, b1.shape)
        # print(max_ay, W2.shape, features_y.T.shape, b2.shape)
